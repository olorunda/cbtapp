    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>CBT&nbsp;</b>@if(Auth::user()->type==1)Admin @else Student @endif</span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="/"><i class="fa fa-link"></i> <span>Home</span></a></li>
			  @if(Auth::user()->type==1)      <li><a href="/managestd"><i class="fa fa-link"></i> <span>Manage Students</span></a></li> 
			...
			@if(Auth::user()->type==0)  <li><a href="/taketest"><i class="fa fa-link"></i> <span>Take Test / View Result</span></a></li> @endif
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">Fix25Ng</a>.</strong> All rights reserved.
      </footer>
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">CBT Training</a>
			</div>
